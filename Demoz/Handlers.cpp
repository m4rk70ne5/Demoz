...
int SpawnSettingsDialog(Windows::tControl* control)
{
    ...
    settingsDialog.AddControl((tControl*)(new tButton("&Save", 510, 40, 116, 35, IDC_BTN_QUIT2))); // change id later
    settingsDialog.AddControl((tControl*)(new tButton("&Cancel", 510, 95, 116, 35, IDC_BTN_QUIT2))); // change id later
    settingsDialog.AddControl((tControl*)(new tControl(10, 30, 105, 25, "&Shader Path:")));
    settingsDialog.AddControl((tControl*)(new tEdit(TEXT("Shader Path"), 135, 30, 300, 25, IDC_TEXT1))); // change id later
    settingsDialog.AddControl((tControl*)(new tBrowseButton(". . .", 445, 30, 35, 25, IDC_BTN_BROWSE1, IDC_TEXT1, SpawnFileBrowser)));
    settingsDialog.AddControl((tControl*)(new tControl(10, 75, 110, 25, "&Resource Dir:")));
    settingsDialog.AddControl((tControl*)(new tEdit(TEXT("Texture Path"), 135, 75, 300, 25, IDC_TEXT2))); // change id later
    settingsDialog.AddControl((tControl*)(new tControl(10, 120, 105, 25, "&Output Dir:"))); // change id later
